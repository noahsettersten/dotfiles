...
# TODO
- Set up mutt for PCO email (OAuth)
...
- Nvim/Helix: Move between splits with tmux keys
- Consider kanata for key mapping instead of Karabiner Elements:
    https://github.com/jtroo/kanata/blob/main/cfg_samples/simple.kbd#L62
